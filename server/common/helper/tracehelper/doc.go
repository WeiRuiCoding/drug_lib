...
// instrumenting the routing of a received message (the GinMiddleware function)
// and instrumenting the response generation through template evaluation (the
// HTML function).
package tracehelper // import "go.opentelemetry.io/contrib/instrumentation/github.com/gin-gonic/gin/otelgin"
